    ...
    <main className='min-h-screen bg-[#090b11] pb-10 text-white'>
      <div className='mx-auto max-w-2xl px-4 py-6 sm:px-6'>
        ...
        <section className='rounded-2xl border border-white/10 bg-[#101525] p-4 sm:p-6 mb-6'>
          ...
          <button type='button' onClick={handleWithdraw} disabled={loading || numericAmount < 1 || !pixKey.trim() || emailVerified === false} className='w-full rounded-xl bg-[#d4a843] px-6 py-3.5 text-base font-bold text-[#04111d] transition-all hover:bg-[#e0b84d] disabled:opacity-50 flex items-center justify-center gap-2'>
