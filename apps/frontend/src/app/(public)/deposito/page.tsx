          ...
          <section className='rounded-2xl border border-white/10 bg-[#101525] p-4 sm:p-6'>
            ...
            <div className='flex items-start gap-2 rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-3 mb-5'>
              ...
              <p className='text-xs text-emerald-100/90 leading-relaxed'>
                Depósito por PIX a partir de <strong>qualquer titular</strong>: pode pagar com a chave de outro CPF. Atenção: <strong>saques só vão pro CPF cadastrado</strong> na conta Palpite201.
              </p>
            </div>
