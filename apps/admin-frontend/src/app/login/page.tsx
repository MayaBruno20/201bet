...
import { login as apiLogin, loginVerify2FA } from '@/lib/auth';
      ...
      <div className="hidden lg:flex relative items-center justify-center p-12 overflow-hidden"
        ...
        <div className="relative z-10 max-w-md">
          <div className="flex items-center gap-4 mb-8">
            ...
            <img src="/images/logoSemFundo.png" alt="201bet" className="h-20 w-auto"/>
            <div>
      ...
      <div className="flex items-center justify-center p-6 lg:p-10">
        <div className="w-full max-w-[400px]">
          <div className="lg:hidden flex items-center gap-2 mb-8">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/logoSemFundo.png" alt="201bet" className="h-14 w-auto"/>
          </div>
