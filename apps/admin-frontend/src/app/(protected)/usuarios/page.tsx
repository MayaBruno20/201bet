...
export default function UsuariosPage() {
  ...
  // Form de edição — todos os campos opcionais (PATCH manda só o que mudou).
  // password fica vazio por padrão; só envia se admin digitar algo.
  ...
  const submitEdit = async () => {
    ...
    setBusy(true);
    try {
      // PATCH envia só campos mudados. Senha só vai se admin digitou algo.
