...
/**
 * Filtra um array de itens por janela temporal em horas, baseado num campo de
 * data. `hours=0` → retorna todos. Útil pra apostas/transações que vêm em lista
 * completa e filtramos client-side.
 */
